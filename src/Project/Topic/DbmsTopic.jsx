  ...
  return (
      ...
      >
        ...
        <p className="text-lg md:text-xl mt-4">
          Click below to start learning DBMS in one shot.
        </p>
      </motion.div>
      ...
      <div className="max-w-3xl mx-auto">
        ...
        >
          <h2 className="text-2xl md:text-3xl font-bold mb-3">DBMS ONE SHOT</h2>
          <p className="text-sm md:text-base mb-6">
            Learn the basics of Database Management Systems with structured videos.
          </p>
          <motion.button
            whileHover={{ scale: 1.05 }}
            whileTap={{ scale: 0.95 }}
