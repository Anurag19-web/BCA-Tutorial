    ...
    <div className={`min-h-screen ${theme === "dark" ? "bg-black text-white" : "bg-white text-black"} py-20 px-6`}>
      ...
      >
        ...
        <p className="text-lg md:text-xl mt-4">
          Click below to start learning Java efficiently.
        </p>
      </motion.div>
      ...
      <div className="max-w-3xl mx-auto">
        ...
        >
          <h2 className="text-2xl md:text-3xl font-bold mb-3">JAVA ONE SHOT</h2>
          <p className="text-sm md:text-base mb-6">
            Learn the basics of Java programming with clear and concise examples.
          </p>
          <motion.button
            whileHover={{ scale: 1.05 }}
            whileTap={{ scale: 0.95 }}
