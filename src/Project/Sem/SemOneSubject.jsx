...
export const SemOneSubject = () => {
  ...
  const subjects = [
    { title: "HTML", desc: "Explore videos on HTML.", link: "/html/topic", color: "from-red-400 to-red-600" },
    { title: "CSS", desc: "Explore videos on CSS.", link: "/css/topic", color: "from-green-400 to-green-600" },
    { title: "CODE", desc: "Explore videos on CODE.", link: "/code/topic", color: "from-blue-400 to-blue-600" },
  ];
